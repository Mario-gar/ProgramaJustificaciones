...
In ProgramaJustificacion-labels_en.properties:
ProgramaJustificacion=My application
ProgramaJustificacion[description]=My application does this and that

In ProgramaJustificacion-messages_en.properties:
